...
exports.FileBasedChatSession = void 0;
const uuid_1 = require("../../common/utils/uuid");
/**
 * The file based chat session
 * @TODO recentMessages 저장 시점 및 페이징 처리 로직 추가
 */
class FileBasedChatSession {
    sessionId;
    storage;
    metadata;
    historyCompressor;
    titleCompressor;
    constructor(sessionId, storage, metadata, historyCompressor, titleCompressor) {
...
exports.FileBasedChatSession = FileBasedChatSession;
//# sourceMappingURL=file-based-chat-session.js.map