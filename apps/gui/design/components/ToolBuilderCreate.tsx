          ...
          <div className="max-w-2xl mx-auto space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">
                Tell us what you want your tool to do. Our AI will analyze your request and generate the perfect tool for you.
              </p>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Describe your tool in natural language. Be as specific as possible about what it should do.
                </CardDescription>
              </CardHeader>
                ...
                <Card>
                  ...
                  <CardContent className="prose prose-sm max-w-none">
                    ...
                    <code className="block bg-muted p-2 rounded text-xs">
                      await slackMessenger.execute({"{"}<br/>
                      &nbsp;&nbsp;channel: "#general",<br/>
                      &nbsp;&nbsp;text: "Hello from AgentOS!"<br/>
                      {"}"})
                    </code>
                  </CardContent>
                </Card>
          ...
          <div className="flex items-center gap-3">
            {currentStep !== "deploy" && (
              ...
              >
                ...
                {currentStep === "describe" ? "Analyze Request" : 
                 currentStep === "analyze" ? "Generate Code" :
                 currentStep === "generate" ? "Run Tests" :
                 "Deploy Tool"}
              </Button>
            )}
