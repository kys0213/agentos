...
export class GeneratedBridgeControllerStub {
  ...
  async register(@Payload(new ZodValidationPipe(C.methods['register']['payload'])) payload: z.input<typeof C.methods['register']['payload']>): Promise<z.output<typeof C.methods['register']['response']>> {
  ...
  async unregister(@Payload(new ZodValidationPipe(C.methods['unregister']['payload'])) payload: z.input<typeof C.methods['unregister']['payload']>): Promise<z.output<typeof C.methods['unregister']['response']>> {
  ...
  async switch(@Payload(new ZodValidationPipe(C.methods['switch']['payload'])) payload: z.input<typeof C.methods['switch']['payload']>): Promise<z.output<typeof C.methods['switch']['response']>> {
  ...
  async get_config(@Payload(new ZodValidationPipe(C.methods['get-config']['payload'])) payload: z.input<typeof C.methods['get-config']['payload']>): Promise<z.output<typeof C.methods['get-config']['response']>> {
