...
@Controller()
export class GeneratedMcpControllerStub {
  ...
  usage_events(): Observable<z.output<typeof C.methods['usage.events']['streamResponse']>> {
    // Expected return: Observable<z.output<typeof C.methods['usage.events']['streamResponse']>>
    throw new Error('NotImplemented: stream mcp.usage.events');
  }
}
