...
export type usage_getLogs_Payload = import('zod').infer<
  (typeof import('../contracts/mcp.contract').McpContract)['methods']['usage.getLogs']['payload']
>;
export type usage_getLogs_Result = import('zod').infer<
  (typeof import('../contracts/mcp.contract').McpContract)['methods']['usage.getLogs']['response']
>;
