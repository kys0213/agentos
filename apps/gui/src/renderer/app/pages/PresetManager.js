...
const PresetManager = () => {
  ...
  return _jsxs(Box, {
    p: 2,
    children: [
      _jsx(Text, { fontWeight: 'bold', mb: 2, children: 'Presets' }),
      _jsx(List, {
        spacing: 1,
        styleType: 'disc',
        pl: 4,
          ...
          _jsxs(
            ListItem,
            {
              children: [
                p.name,
                ' ',
                _jsx(Button, { size: 'xs', onClick: () => handleDelete(p.id), children: 'Delete' }),
              ],
            },
            p.id
          )
      ...
      _jsxs(VStack, {
        ...
        children: [
          ...
          _jsx(Button, { size: 'sm', onClick: handleSave, colorScheme: 'brand', children: 'Add' }),
        ],
      }),
    ],
  });
