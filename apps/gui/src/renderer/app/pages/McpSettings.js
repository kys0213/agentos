  ...
  return _jsx(Box, {
    ...
    children: _jsxs(Stack, {
      ...
      children: [
        _jsxs(FormControl, {
          children: [
            _jsx(FormLabel, { children: 'Type' }),
            _jsxs(Select, {
              value: type,
              onChange: (e) => setType(e.target.value),
              children: [
                _jsx('option', { value: 'stdio', children: 'stdio' }),
                _jsx('option', { value: 'streamableHttp', children: 'streamableHttp' }),
        ...
        _jsxs(FormControl, {
          children: [
            ...
            _jsx(Input, { value: name, onChange: (e) => setName(e.target.value) }),
          ],
        }),
        _jsxs(FormControl, {
          children: [
            _jsx(FormLabel, { children: 'Version' }),
            _jsx(Input, { value: version, onChange: (e) => setVersion(e.target.value) }),
          ],
        }),
        type === 'stdio' &&
          _jsxs(_Fragment, {
            children: [
              _jsxs(FormControl, {
                children: [
                  _jsx(FormLabel, { children: 'Command' }),
                  _jsx(Input, { value: command, onChange: (e) => setCommand(e.target.value) }),
                ],
              }),
              _jsxs(FormControl, {
                children: [
                  _jsx(FormLabel, { children: 'Args' }),
                  _jsx(Input, {
                    value: args,
        ...
        type !== 'stdio' &&
          _jsxs(FormControl, {
            children: [
              _jsx(FormLabel, { children: 'URL' }),
              _jsx(Input, { value: url, onChange: (e) => setUrl(e.target.value) }),
            ],
          }),
        _jsx(Button, {
          type: 'submit',
