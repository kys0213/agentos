...
const LlmBridgeManager = ({ store, manager, onChange }) => {
  ...
  return _jsxs(Box, {
    p: 2,
    children: [
      _jsx(Text, { fontWeight: 'bold', mb: 2, children: 'LLM Bridges' }),
      _jsx(VStack, {
        align: 'start',
        spacing: 2,
        as: 'ul',
        ...
        children: (bridges || []).map((b) =>
          _jsxs(
            HStack,
            {
              ...
              spacing: 2,
              children: [
                _jsxs(Text, { children: [b.id, ' (', b.type, ')'] }),
                _jsx(Button, { size: 'xs', onClick: () => handleDelete(b.id), children: 'Delete' }),
              ],
            },
            b.id
          )
      ...
      _jsxs(HStack, {
        ...
        children: [
          ...
          _jsxs(Select, {
            ...
            w: 'auto',
            children: [
              _jsx('option', { value: 'echo', children: 'echo' }),
              _jsx('option', { value: 'reverse', children: 'reverse' }),
            ],
          }),
          _jsx(Button, { size: 'sm', onClick: handleAdd, colorScheme: 'brand', children: 'Add' }),
        ],
      }),
    ],
  });
